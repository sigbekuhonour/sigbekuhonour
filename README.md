...
* Full-time Software Engineering / Software Development internship positions — Summer 2026
* Availability - I'm available for up to 16 months starting from Summer 2026
...
* 🎓 **Academic Foundation** — Currently undergoing my Bachelor of Science degree in Computer Science with an expected graduation in Fall 2027 | **GPA: 3.27 / 4.0**.
...
* **Studyhub:** StudyHub is a student-focused note taking and collaboration tool designed to enhance studying, retention, and revision.
* **SDSJ (Software Developer Group of St. John's):** Co-founding a community for local developers to share knowledge and build together.
